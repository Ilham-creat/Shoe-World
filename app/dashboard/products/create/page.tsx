        ...
        <Card className="mt-5">
            ...
            <CardContent>
                <div className="flex flex-col gap-6">
                    ...
                    defaultValue ={fields.name.initialValue} className ="w-full" placeholder="Product Name"
                    />
                    ...
                    defaultValue={fields.description.initialValue} placeholder="Write your description right here..."/>
                    ...
                    name= {fields.status.name} defaultValue={fields.status.initialValue}>
