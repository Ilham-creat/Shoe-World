...
export function CategoriesSelection(){
    ...
    <div className="flex justify-between items-center">
        ...
        <div className="mt-6 grid grid-col-1 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6 lg:gap-8">
            ...
            <Image src={first} alt="All products Image" className="object-cover object-center"/>
            ...
            <div className = "group aspect-w-2 aspect-h-1 rounded-lg overflow-hidden sm:hidden sm:relative sm:aspect-none sm:h-full">
            <Image src={second} alt=" products for men Image" className="object-cover object-center sm:absolute sm:inset-0 sm:w-full sm:h-full"/>
            ...
            <div className = "group aspect-w-2 aspect-h-1 rounded-lg overflow-hidden sm:hidden sm:relative sm:aspect-none sm:h-full">
            <Image src={third} alt="Women products Image" className="object-cover object-center sm:absolute sm:inset-0 sm:w-full sm:h-full"/>
            <div className="bg-gradient-to-b from-transparent to-black opacity-55 sm:absolute sm:inset-0"/>
            <div className="p-6 flex items-end sm:absolute sm:inset-0">
            <Link href= "/products/all">
