        ...
        <Card className="mt-5">
            ...
            <CardContent>
                <div className="flex flex-col gap-6">
                    ...
                    defaultValue ={data.name} className ="w-full" placeholder="Product Name"
                    />
                    ...
                    defaultValue={data.description} placeholder="Write your description right here..."/>
                    ...
                    name= {fields.status.name} defaultValue={data.status}>
