...
export default async function BagRoute(){
    ...
    return (
        ...
        justify-center rounded-lg border-dashed p-8 text-center mt-20">
        ...
        <p className="mb-8 mt-2 text-center text-sm leading-6 
            text-muted-foreground max-w-sm mx-auto">You currently dont have any Shopping Bag.
            Please add some so that you can see them right here.</p>
